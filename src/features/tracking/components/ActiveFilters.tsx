...
import { ActiveDeliveryFilters as FiltersType } from '@/types/tracking';
...
export function ActiveFilters({ filters, onFilterChange, onClear, onRefresh, isRefreshing }: ActiveFiltersProps) {
